...
/**
 * Creates a transfer instruction only. Full flows must generate the equality, validity, and range
 * proofs separately and may use proof context-state transactions, depending on network support.
 */
 ...
 * full flows must generate its five proofs separately and may use proof context-state transactions.
 */
